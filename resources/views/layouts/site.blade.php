...
<head>
    ...
    @isset ($_pageTitle)
        <title>{{$_pageTitle}} | AdlCoffeeTracker</title>
    @else
        <title>AdlCoffeeTracker</title>
    @endisset
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <div class="flex flex-row items-center">
                    ...
                    <span class="ml-3 font-semibold">AdlCoffeeTracker</span>
                </div>
                    ...
                    <div class="space-x-4 flex flex-row">
                        ...
                        <a href="" class="p-2 px-4 text-white bg-purple-400 rounded-2xl hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-opacity-50">
                            <div class="flex flex-row items-center">
                                ...
                                <span class="font-bold">Report Price</span>
                            </div>
                        </a>
                    </div>
                </div>
